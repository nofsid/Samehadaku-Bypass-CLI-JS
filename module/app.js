...
(async () => {
  ...
  switch (cmd) {
    case "list":
      getList(
        url + "wp-json/wp/v2/posts?per_page=14&page=1",
        args.s === true || args.save === true
      );
      break;
    case "page":
      let page = args._[1] || 1;
      getList(
        url + "wp-json/wp/v2/posts?per_page=14&page=" + page,
        args.s === true || args.save === true
      );
      break;
    case "from":
...
options: [-s|--save] for save link to text file with json format`
    ...
    case "zippydl":
      ...
      if (!url) {
        console.log(
          'Please insert url, e.g : samehadaku zippydl "https://xxx.zippyshare.com/v/xxx/file.html"'
        );
        break;
      }
      ZippyDL(url);
    ...
    case "gdrivedl":
      ...
      if (!url) {
        console.log(
          'Please insert url, e.g : samehadaku gdrive "https://drive.google.com/open?id=xxx" or "https://drive.google.com/file/d/xxx/view"'
        );
        break;
      }
      GDriveDL(url);
